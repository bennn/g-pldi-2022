...
\newenvironment{langarray}{\(\begin{array}[t]{l@{\hspace{0.2em}}c@{\hspace{0.2em}}l}}{\end{array}\)}
...
\newcommand{\snrbreak}{\snr\\{}\hfill}
\newcommand{\scc}{\rightarrow}
\newcommand{\srr}{\scc^{*}}
\newcommand{\srrlbl}{\stackrel{\kern -5pt \raisebox{-1.2ex}[0pt][-2pt]{\footnotesize +}}{\srr}}
