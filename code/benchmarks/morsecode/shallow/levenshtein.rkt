...
(: vector-levenshtein/predicate (-> (Vectorof Char) (Vectorof Char) (-> Char Char Boolean) Index))
...
(: %string-levenshtein/predicate (-> String String (-> Char Char Boolean) Index))
...
;  (let ((foo (lambda ([a : LType]
;                      [b : LType]
;                      [pred : (-> Char Char Boolean)]
;                      [a-emp : (-> LType Boolean)]
;                      [a-len : (-> LType Index)]
;                      [a-vec : (-> LType (Vectorof Char))])
;               (let ((bar (lambda ([b-emp : (case->
;                                              (-> (Listof Char) Boolean)
;                                              (-> (Vectorof Char) Boolean)
;                                              (-> LType Boolean)
;                                              (-> String Boolean))]
;                                   [b-len : (-> LType Index)]
;                                   [b-vec : (-> LType (Vectorof Char))])
;                            (if (b-emp b)
;                                (a-len a)
